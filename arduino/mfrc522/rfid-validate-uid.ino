...
void setup() {
	...
	Serial.println(F("Mifare Classic Card Details"));
...
//Converting UID to Hex
  ...
  if(content.substring(1)!=uidString){
     clearUID();
     uidString=content.substring(1); 
     if(uidString=="21 55 2B 1A" || uidString=="E2 DE 05 19"){
      ValidUID();
     }else{
      inValidUID(); 
     }
