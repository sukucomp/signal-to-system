...
- `rfid_serial_ingestor.py`
  Python serial listener that reads `EVENT:{...}` messages and prints parsed output. I am using Visual Studio Code (VSC) which can be downloaded from [here](https://code.visualstudio.com/).
- `program.cs`
